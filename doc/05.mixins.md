...
The parameter {package} can be very useful. It allows you to specify which classes you want to generate. Here's a list of available values that you can use :
